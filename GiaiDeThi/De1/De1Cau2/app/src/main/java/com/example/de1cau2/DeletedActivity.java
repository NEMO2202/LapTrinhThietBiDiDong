...
import static com.example.adapter.HelperAdapter.*;
        ...
        public void onClick (View view) {
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                   ...
                   long numbOfRow = db.DeletedEmployee(binding.edtEmployeeId.getText().toString(),binding.edtEmployeeName.toString(),Integer.parseInt(binding.edtEmployeeAge.getText().toString()));
                    if (numbOfRow > 0) {
